...
int main(void)
{
    ...
    for (counter = 0; counter < 400; counter++)
        ;
    GPIO_F_DEN->pins.pin3 = 1; // Green
    GPIO_F_DEN->pins.pin1 = 1; // Red
    GPIO_F_DEN->pins.pin2 = 1; // Blue

    GPIO_F_DIR->pins.pin3 = 1;
    GPIO_F_DIR->pins.pin2 = 1;
    GPIO_F_DIR->pins.pin1 = 1;
    while (1)
    {
        ...
        for (counter = 0; counter < 500000; counter++)
            ;
        GPIO_F_DATA->pins.pin1 = 1;
        for (counter = 0; counter < 500000; counter++)
            ;
        GPIO_F_DATA->pins.pin1 = 0;
        for (counter = 0; counter < 500000; counter++)
            ;
        GPIO_F_DATA->pins.pin2 = 1;
        for (counter = 0; counter < 500000; counter++)
            ;
        GPIO_F_DATA->pins.pin2 = 0;
        for (counter = 0; counter < 500000; counter++)
            ;
    }
    return 0;
